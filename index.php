...
<?php include('slider.php'); ?>
     ...
     <div class="about section" id="section-2">
	  ...
	  <img src="images/about-img.png" alt="">
	   ...
	   <div class="container">		  
		 <p>Traveling is one of the most common activities for people, especially during the summer vacation people go around the world to visit different places and enjoy their time with  family or friends.
Nearly everyone goes on a vacation outside of his  residing city. People can go to different locations on their own . But they are unaware of the place which they  have  planned to visit . So they need to know several factors such as total cost in the toure , fooding and lodging and much more.   So they need someone who will help in perfect planning of their toure,and so they contact to a travel agent. The travel agent makes arrangements for the toure so that no problems are faced in a foreign land. The travel agency appoints a tour operator  for each individual toure arranged by the agency. A tour operator will be responsible for all the issues related to travel in that particular trip.
                                The project being developed by me is an integrated software for the tour operating companies This project will help a travel agency to manage the toures using computers and provide tourism functionalities online to the travellers.  The main function of this project is to help traveling agencies to manage travellers and their tour in a professional way using computer and internet. The proposed system maintains centralized database to make necessary travel arrangements and to retrieve information easily by the users of this website.
</p>
	 </div>
</div>	
...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <div class="container">
				<p>My Tour guides are expensive, so first decide what you want to do, whether it's a general tour of a city, a day of hiking, or visiting remote places in other country. Once you have chosen a guide, you'll probably refine your ideas based upon the guide's knowledge.</p>
		  </div>
	  </div>
	  <div class="container">
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Travel Agency</h4>
						<p style="color:#000"> HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 1203456789&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 9876543210</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info[at]traveltour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support[at]mytour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>221-B, Paharganj</h5>
                        <br/>
